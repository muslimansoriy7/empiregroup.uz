...
export const metadata = {
  title: "Odoo ERP joriy qilishning 5 fazasi — Empire Group",
  description:
    ...
    <div className="oj-figure" style={{marginTop:36}}>
      <svg viewBox="0 0 1000 152" role="img" aria-label="Odoo joriy etish — besh fazali zanjir">
        <g fontFamily="'Outfit',sans-serif">
          <line x1="100" y1="62" x2="900" y2="62" stroke="#2A3A50" strokeWidth="2.5" />
          <g>
            <circle cx="100" cy="62" r="26" fill="#132238" stroke="#C8A24A" strokeWidth="2" />
            <text x="100" y="68" textAnchor="middle" fill="#C8A24A" fontSize="17" fontWeight="700">01</text>
            <text x="100" y="112" textAnchor="middle" fill="#E8ECF1" fontSize="15" fontWeight="600">Discovery</text>
            <text x="100" y="130" textAnchor="middle" fill="#8b9198" fontSize="11">Biznes-analiz</text>
          </g>
          <g>
            <circle cx="310" cy="62" r="26" fill="#132238" stroke="#C8A24A" strokeWidth="2" />
            <text x="310" y="68" textAnchor="middle" fill="#C8A24A" fontSize="17" fontWeight="700">02</text>
            <text x="310" y="112" textAnchor="middle" fill="#E8ECF1" fontSize="15" fontWeight="600">Design</text>
            <text x="310" y="130" textAnchor="middle" fill="#8b9198" fontSize="11">Loyiha dizayni</text>
          </g>
          <g>
            <circle cx="510" cy="62" r="30" fill="#A47D30" stroke="#C8A24A" strokeWidth="2.5" />
            <text x="510" y="68" textAnchor="middle" fill="#1A0F00" fontSize="17" fontWeight="700">03</text>
            <text x="510" y="112" textAnchor="middle" fill="#ffffff" fontSize="15" fontWeight="700">Build</text>
            <text x="510" y="130" textAnchor="middle" fill="#C8A24A" fontSize="11">Eng asosiy faza</text>
          </g>
          <g>
            <circle cx="720" cy="62" r="26" fill="#132238" stroke="#6889A8" strokeWidth="2" />
            <text x="720" y="68" textAnchor="middle" fill="#8EACC8" fontSize="17" fontWeight="700">04</text>
            <text x="720" y="112" textAnchor="middle" fill="#E8ECF1" fontSize="15" fontWeight="600">Deploy</text>
            <text x="720" y="130" textAnchor="middle" fill="#8b9198" fontSize="11">Ishga tushirish</text>
          </g>
          <g>
            <circle cx="930" cy="62" r="26" fill="#132238" stroke="#6889A8" strokeWidth="2" />
            <text x="930" y="68" textAnchor="middle" fill="#8EACC8" fontSize="17" fontWeight="700">05</text>
            <text x="930" y="112" textAnchor="middle" fill="#E8ECF1" fontSize="15" fontWeight="600">Support</text>
            <text x="930" y="130" textAnchor="middle" fill="#8b9198" fontSize="11">Barqarorlik</text>
          </g>
          <text x="500" y="20" textAnchor="middle" fill="#8b9198" fontFamily="'Outfit',sans-serif" fontSize="11" letterSpacing="3">ZANJIR &middot; HAR DARVOZA YOPILGACH KEYINGISIGA O&rsquo;TILADI &rarr;</text>
        </g>
      </svg>
  ...
  <div className="oj-wrap">
    ...
    <div className="oj-figure">
      ...
      <svg viewBox="0 0 1000 168" role="img" aria-label="Klassik loyiha yo'li — chevron bosqichlar">
        <g fontFamily="'Outfit',sans-serif">
          <text x="0" y="20" fill="#8b9198" fontSize="12" letterSpacing="2">KLASSIK LOYIHA YO&rsquo;LI</text>
          <path d="M20,42 L206,42 L236,82 L206,122 L20,122 Z" fill="#6889A8" opacity=".42" />
          <path d="M206,42 L392,42 L422,82 L392,122 L206,122 L236,82 Z" fill="#6889A8" opacity=".62" />
          <path d="M392,42 L578,42 L608,82 L578,122 L392,122 L422,82 Z" fill="#6889A8" />
          <path d="M578,42 L764,42 L794,82 L764,122 L578,122 L608,82 Z" fill="#C8A24A" />
          <path d="M764,42 L950,42 L980,82 L950,122 L764,122 L794,82 Z" fill="#1A2D48" stroke="#3A4A60" strokeWidth="1.5" />
          <g textAnchor="middle" fill="#ffffff" fontWeight="700">
            <text x="132" y="90" fontSize="20">10%</text>
            <text x="318" y="90" fontSize="20">5%</text>
            <text x="504" y="92" fontSize="26">80%</text>
            <text x="690" y="90" fontSize="20" fill="#1A0F00">5%</text>
            <text x="876" y="92" fontSize="22" fill="#8b9198">—</text>
          </g>
          <g textAnchor="middle" fontSize="12.5" fill="#E8ECF1">
            <text x="128" y="150">ROI tahlili</text>
            <text x="314" y="150">Kick-Off</text>
            <text x="500" y="150" fontWeight="600" fill="#ffffff">Joriy etish</text>
            <text x="686" y="150" fill="#C8A24A">Go-Live</text>
            <text x="872" y="150" fill="#8b9198">Ikkinchi joylashtirish</text>
          </g>
        </g>
      </svg>
      ...
      <svg viewBox="0 0 1000 210" role="img" aria-label="Umumiy kuch taqsimoti bari" style={{marginTop:8}}>
        <g fontFamily="'Outfit',sans-serif">
          <text x="0" y="24" fill="#8b9198" fontSize="12" letterSpacing="2">UMUMIY KUCH TAQSIMOTI — nisbiy og&rsquo;irlik</text>
          <rect x="0" y="56" width="94" height="56" rx="4" fill="#C8A24A" opacity=".45" />
          <rect x="98" y="56" width="42" height="56" rx="4" fill="#C8A24A" opacity=".62" />
          <rect x="144" y="56" width="700" height="56" rx="4" fill="#A47D30" />
          <rect x="848" y="56" width="42" height="56" rx="4" fill="#6889A8" opacity=".85" />
          <rect x="894" y="56" width="106" height="56" rx="4" fill="#6889A8" opacity=".38" />
          <text x="47" y="90" textAnchor="middle" fill="#1A0F00" fontSize="13" fontWeight="700">10%</text>
          <text x="494" y="92" textAnchor="middle" fill="#1A0F00" fontSize="18" fontWeight="700">80%</text>
          <text x="869" y="90" textAnchor="middle" fill="#ffffff" fontSize="12" fontWeight="700">5%</text>
          <g fill="#E8ECF1" fontSize="12.5" textAnchor="middle">
            <text x="47" y="140">ROI tahlili</text>
            <text x="119" y="140" fill="#8b9198">Kick-Off</text>
            <text x="494" y="140" fontWeight="600" fill="#ffffff">Joriy etish (Build)</text>
            <text x="869" y="140" fill="#8EACC8">Go-Live</text>
            <text x="947" y="140" fill="#8b9198" fontSize="11">Ikkinchi<tspan x="947" dy="14">joylashtirish</tspan></text>
          </g>
          <text x="494" y="184" textAnchor="middle" fill="#8b9198" fontSize="12.5">Har hafta demo — metodologiyaning yuragi. Demo bo&rsquo;lmagan hafta — yo&rsquo;qotilgan hafta.</text>
        </g>
      </svg>
      ...
      <div className="oj-phase-body">
        ...
        <div className="oj-figure">
          <svg viewBox="0 0 1000 300" role="img" aria-label="GAP tahlili va MoSCoW matritsasi">
            <g fontFamily="'Outfit',sans-serif">
              <text x="0" y="22" fill="#8b9198" fontSize="12" letterSpacing="2">GAP = EHTIYOJ − STANDART</text>
              <rect x="0" y="42" width="250" height="40" rx="6" fill="#C8A24A" opacity=".9" />
              <text x="125" y="67" textAnchor="middle" fill="#1A0F00" fontSize="13" fontWeight="700">Odoo standart (Fit)</text>
              <rect x="0" y="94" width="360" height="40" rx="6" fill="#132238" stroke="#6889A8" strokeWidth="1.5" />
              <rect x="250" y="94" width="110" height="40" rx="6" fill="#6889A8" opacity=".55" />
              <text x="125" y="119" textAnchor="middle" fill="#E8ECF1" fontSize="13">Mijoz ehtiyoji</text>
              <text x="305" y="119" textAnchor="middle" fill="#ffffff" fontSize="12" fontWeight="700">GAP</text>
              <text x="0" y="160" fill="#8b9198" fontSize="12">GAP — standart qoplamagan qism. Uni MoSCoW bo&rsquo;yicha saralaymiz →</text>
            </g>
            <g fontFamily="'Outfit',sans-serif" transform="translate(430,30)">
              <rect x="0" y="0" width="270" height="115" rx="10" fill="rgba(164,125,48,.14)" stroke="#A47D30" strokeWidth="1.5" />
              <text x="16" y="30" fill="#C8A24A" fontSize="15" fontWeight="700">MUST &middot; Majburiy</text>
              <text x="16" y="54" fill="#E8ECF1" fontSize="12.5" fontFamily="'Outfit',sans-serif">Usiz biznes yurmaydi.</text>
              <text x="16" y="76" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">&rarr; Tasdiqlanadi, ishlab chiqiladi</text>
              <rect x="290" y="0" width="270" height="115" rx="10" fill="rgba(200,162,74,.08)" stroke="rgba(200,162,74,.4)" strokeWidth="1.5" />
              <text x="306" y="30" fill="#C8A24A" fontSize="15" fontWeight="700">SHOULD &middot; Muhim</text>
              <text x="306" y="54" fill="#E8ECF1" fontSize="12.5" fontFamily="'Outfit',sans-serif">Vaqtincha workaround mumkin.</text>
              <text x="306" y="76" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">&rarr; 2-bosqichga suriladi</text>
              <rect x="0" y="130" width="270" height="115" rx="10" fill="rgba(104,137,168,.10)" stroke="rgba(104,137,168,.4)" strokeWidth="1.5" />
              <text x="16" y="160" fill="#8EACC8" fontSize="15" fontWeight="700">COULD &middot; Yaxshi bo&rsquo;lardi</text>
              <text x="16" y="184" fill="#E8ECF1" fontSize="12.5" fontFamily="'Outfit',sans-serif">Qulaylik, ta&rsquo;siri kam.</text>
              <text x="16" y="206" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">&rarr; Rad etiladi</text>
              <rect x="290" y="130" width="270" height="115" rx="10" fill="rgba(104,137,168,.16)" stroke="#6889A8" strokeWidth="1.5" />
              <text x="306" y="160" fill="#8EACC8" fontSize="15" fontWeight="700">WON&rsquo;T &middot; Qilinmaydi</text>
              <text x="306" y="184" fill="#E8ECF1" fontSize="12.5" fontFamily="'Outfit',sans-serif">Byudjet/muddatga sig&rsquo;maydi.</text>
              <text x="306" y="206" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">&rarr; Qat&rsquo;iy rad</text>
            </g>
          </svg>
      ...
      <div className="oj-phase-body">
        ...
        <div className="oj-figure">
          <svg viewBox="0 0 1000 300" role="img" aria-label="Bir haftalik sprint sikli">
            <g fontFamily="'Outfit',sans-serif">
              <text x="500" y="24" textAnchor="middle" fill="#8b9198" fontSize="12" letterSpacing="3">BIR HAFTALIK SPRINT SIKLI</text>
              <circle cx="500" cy="165" r="96" fill="none" stroke="#A47D30" strokeWidth="1.5" strokeDasharray="4 6" opacity=".6" />
              <text x="500" y="160" textAnchor="middle" fill="#ffffff" fontSize="16" fontWeight="700">1 HAFTA</text>
              <text x="500" y="182" textAnchor="middle" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">sprint</text>
              {/* top: Qo'ng'iroq */}
              <rect x="410" y="42" width="180" height="52" rx="10" fill="#132238" stroke="#C8A24A" strokeWidth="1.5" />
              <text x="500" y="66" textAnchor="middle" fill="#C8A24A" fontSize="14" fontWeight="700">Qo&rsquo;ng&rsquo;iroq</text>
              <text x="500" y="84" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">SPoC bilan haftalik</text>
              {/* right: Sozlash */}
              <rect x="720" y="139" width="180" height="52" rx="10" fill="#132238" stroke="#C8A24A" strokeWidth="1.5" />
              <text x="810" y="163" textAnchor="middle" fill="#C8A24A" fontSize="14" fontWeight="700">Sozlash</text>
              <text x="810" y="181" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">jonli tizimda birga</text>
              {/* bottom: Uyga vazifa */}
              <rect x="410" y="236" width="180" height="52" rx="10" fill="#132238" stroke="#6889A8" strokeWidth="1.5" />
              <text x="500" y="260" textAnchor="middle" fill="#8EACC8" fontSize="14" fontWeight="700">Uyga vazifa</text>
              <text x="500" y="278" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">SPoC mustaqil bajaradi</text>
              {/* left: Tekshirish */}
              <rect x="100" y="139" width="180" height="52" rx="10" fill="#132238" stroke="#6889A8" strokeWidth="1.5" />
              <text x="190" y="163" textAnchor="middle" fill="#8EACC8" fontSize="14" fontWeight="700">Tekshirish</text>
              <text x="190" y="181" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">SPoC o&rsquo;zi ko&rsquo;rsatadi</text>
              {/* arrows */}
              <g fill="#A47D30">
      ...
      <div className="oj-phase-body">
        ...
        <div className="oj-figure">
          <svg viewBox="0 0 1000 210" role="img" aria-label="Go-Live cutover jadvali">
            <g fontFamily="'Outfit',sans-serif">
              <text x="0" y="22" fill="#8b9198" fontSize="12" letterSpacing="2">CUTOVER — ESKI TIZIMDAN YANGISIGA O&rsquo;TISH</text>
              <line x1="60" y1="90" x2="940" y2="90" stroke="#2A3A50" strokeWidth="2" />
              <g>
                <circle cx="120" cy="90" r="9" fill="#6889A8" />
                <text x="120" y="60" textAnchor="middle" fill="#ffffff" fontSize="12.5" fontWeight="600">Blackout</text>
                <text x="120" y="118" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">Juma 18:00 —</text>
                <text x="120" y="132" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">eski tizim yopiladi</text>

                <circle cx="330" cy="90" r="9" fill="#C8A24A" />
                <text x="330" y="60" textAnchor="middle" fill="#ffffff" fontSize="12.5" fontWeight="600">Yakuniy qoldiq</text>
                <text x="330" y="118" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">Ombor + bank/kassa</text>
                <text x="330" y="132" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">Excelga olinadi</text>

                <circle cx="540" cy="90" r="9" fill="#C8A24A" />
                <text x="540" y="60" textAnchor="middle" fill="#ffffff" fontSize="12.5" fontWeight="600">Load</text>
                <text x="540" y="118" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">Qoldiqlar Live</text>
                <text x="540" y="132" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">bazaga import</text>

                <circle cx="720" cy="90" r="9" fill="#A47D30" />
                <text x="720" y="60" textAnchor="middle" fill="#ffffff" fontSize="12.5" fontWeight="600">Smoke test</text>
                <text x="720" y="118" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">1 sotuv &middot; 1 xarid</text>
                <text x="720" y="132" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">&middot; 1 to&rsquo;lov</text>

                <circle cx="900" cy="90" r="12" fill="#C8A24A" stroke="#0E1A2B" strokeWidth="3" />
                <text x="900" y="58" textAnchor="middle" fill="#C8A24A" fontSize="13" fontWeight="700">Hypercare</text>
                <text x="900" y="118" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">Dush. — 1–2 hafta</text>
                <text x="900" y="132" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">yonida turish</text>
              </g>
              <text x="500" y="180" textAnchor="middle" fill="#E8ECF1" fontSize="12.5" fontFamily="'Outfit',sans-serif">Xato bo&rsquo;lishi — 100% normal. Asosiysi xatoning o&rsquo;zi emas, unga qanchalik <tspan fill="#C8A24A" fontWeight="600">tez reaksiya</tspan> bildirishdir.</text>
            </g>
          </svg>
  ...
  <div className="oj-wrap">
    ...
    <div className="oj-figure">
      <svg viewBox="0 0 1000 138" role="img" aria-label="Yakuniy to'rt bosqich davomiyligi">
        <g fontFamily="'Outfit',sans-serif">
          <text x="0" y="18" fill="#8b9198" fontSize="12" letterSpacing="1.5">ERP LOYIHALARINING ~70–75% i AYNAN SHU BOSQICHLARDA QULAYDI</text>
          <rect x="20" y="34" width="90" height="60" rx="7" fill="#C8A24A" />
          <rect x="116" y="34" width="360" height="60" rx="7" fill="#6889A8" />
          <rect x="482" y="34" width="70" height="60" rx="7" fill="#4A6A88" />
          <rect x="558" y="34" width="422" height="60" rx="7" fill="#A47D30" />
          <text x="65" y="70" textAnchor="middle" fill="#1A0F00" fontSize="12" fontWeight="700" transform="rotate(-90 65 64)">TRENING</text>
          ...
          <text x="517" y="70" textAnchor="middle" fill="#ffffff" fontSize="11.5" fontWeight="700" transform="rotate(-90 517 64)">GO-LIVE</text>
          <g textAnchor="middle" fill="#1A0F00">
          ...
          <text x="65" y="112" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">3–5 kun</text>
          <text x="517" y="112" textAnchor="middle" fill="#8b9198" fontSize="11" fontFamily="'Outfit',sans-serif">1 kun</text>
          <text x="500" y="132" textAnchor="middle" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">Ma&#x2BB;lumot kiritish → Trening → Parallel test → Go-Live → Support</text>
        </g>
      </svg>
    ...
    <div className="oj-tblwrap">
      <table>
        ...
        <tbody>
          <tr><td style={{color:'#E0A06A',fontWeight:600,width:'16%'}}>Kritik</td><td className="oj-td-odoo">Biznes ishlolmayapti, hisob-faktura chiqmayapti</td><td className="oj-td-odoo" style={{width:'28%'}}>1 soat ko&rsquo;rish &middot; 4 soat yechim</td></tr>
  ...
  <div className="oj-wrap">
    ...
    <div className="oj-figure">
      <svg viewBox="0 0 1000 340" role="img" aria-label="Mijoz qoniqishi egri chizig'i">
        <g fontFamily="'Outfit',sans-serif">
          <line x1="80" y1="40" x2="80" y2="270" stroke="#2A3A50" strokeWidth="1.5" />
          <line x1="80" y1="270" x2="950" y2="270" stroke="#2A3A50" strokeWidth="1.5" />
          <text x="80" y="26" textAnchor="middle" fill="#8b9198" fontSize="11">QONIQISH ↑</text>
          <text x="950" y="298" textAnchor="end" fill="#8b9198" fontSize="11">LOYIHA BOSQICHLARI →</text>
          <path d="M110,90 C 220,80 260,150 360,175 C 460,200 520,230 610,210 C 660,198 700,150 760,120 C 820,92 880,80 930,72"
                fill="none" stroke="#C8A24A" strokeWidth="3.5" strokeLinecap="round" />
          <path d="M360,175 C 460,200 520,230 610,210 L610,270 L360,270 Z" fill="rgba(104,137,168,.14)" />
          <g>
            <circle cx="110" cy="90" r="6" fill="#C8A24A" />
            <text x="110" y="322" textAnchor="middle" fill="#E8ECF1" fontSize="12">Sotuv</text>
            <circle cx="485" cy="205" r="7" fill="#6889A8" />
            <text x="485" y="322" textAnchor="middle" fill="#8EACC8" fontSize="12" fontWeight="600">Qiyin qarorlar</text>
            <circle cx="700" cy="150" r="8" fill="#A47D30" stroke="#0E1A2B" strokeWidth="2" />
            <text x="700" y="322" textAnchor="middle" fill="#ffffff" fontSize="12" fontWeight="600">Go-Live</text>
            <circle cx="930" cy="72" r="6" fill="#C8A24A" />
            <text x="930" y="322" textAnchor="middle" fill="#E8ECF1" fontSize="12">Natija</text>
          </g>
          <text x="485" y="252" textAnchor="middle" fill="#8EACC8" fontSize="12" fontFamily="'Outfit',sans-serif">vaqtinchalik norozilik</text>
        </g>
      </svg>
  ...
  <div className="oj-wrap">
    ...
    <div className="oj-figure">
      <svg viewBox="0 0 1000 420" role="img" aria-label="Raqamli imkoniyatlar matritsasi">
        <g fontFamily="'Outfit',sans-serif">
          <text x="40" y="210" fill="#8b9198" fontSize="12" transform="rotate(-90 40 210)" textAnchor="middle">POTENSIAL TA&rsquo;SIR ↑</text>
          <text x="530" y="410" fill="#8b9198" fontSize="12" textAnchor="middle">O&rsquo;ZGARTIRISH OSONLIGI →</text>
          <rect x="80" y="40" width="440" height="160" rx="12" fill="rgba(104,137,168,.10)" stroke="rgba(104,137,168,.35)" />
          <rect x="530" y="40" width="440" height="160" rx="12" fill="rgba(164,125,48,.14)" stroke="#A47D30" />
          <rect x="80" y="210" width="440" height="160" rx="12" fill="rgba(104,137,168,.06)" stroke="rgba(104,137,168,.25)" />
          <rect x="530" y="210" width="440" height="160" rx="12" fill="rgba(200,162,74,.08)" stroke="rgba(200,162,74,.35)" />
          <text x="100" y="72" fill="#8EACC8" fontSize="15" fontWeight="700">Game changers</text>
          <text x="100" y="92" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">Yuqori ta&rsquo;sir &middot; yuqori murakkablik → rejalashtiring</text>
          <text x="550" y="72" fill="#C8A24A" fontSize="15" fontWeight="700">Quick wins &middot; 1-ustuvorlik</text>
          <text x="550" y="92" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">Yuqori ta&rsquo;sir &middot; past murakkablik → darhol qiling</text>
          <text x="100" y="242" fill="#8EACC8" fontSize="15" fontWeight="700">To avoid</text>
          <text x="100" y="262" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">Past ta&rsquo;sir &middot; yuqori murakkablik → rad eting</text>
          <text x="550" y="242" fill="#C8A24A" fontSize="15" fontWeight="700">Fine tuning</text>
          <text x="550" y="262" fill="#8b9198" fontSize="12" fontFamily="'Outfit',sans-serif">Past ta&rsquo;sir &middot; past murakkablik → vaqt topilsa</text>
          <g opacity=".92">
            <circle cx="640" cy="140" r="34" fill="#C8A24A" opacity=".85" /><text x="640" y="146" textAnchor="middle" fill="#1A0F00" fontSize="13" fontWeight="700">1</text>
            <circle cx="760" cy="120" r="22" fill="#C8A24A" opacity=".7" /><text x="760" y="125" textAnchor="middle" fill="#1A0F00" fontSize="12" fontWeight="700">2</text>
            <circle cx="300" cy="110" r="28" fill="#6889A8" opacity=".8" /><text x="300" y="116" textAnchor="middle" fill="#fff" fontSize="13" fontWeight="700">3</text>
            <circle cx="820" cy="300" r="18" fill="#C8A24A" opacity=".5" /><text x="820" y="305" textAnchor="middle" fill="#1A0F00" fontSize="11" fontWeight="700">4</text>
            <circle cx="240" cy="300" r="16" fill="#6889A8" opacity=".45" /><text x="240" y="305" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="700">5</text>
          </g>
        </g>
      </svg>
  ...
  <div className="oj-wrap">
    ...
    <div className="oj-figure">
      <svg viewBox="0 0 1000 170" role="img" aria-label="Faza darvozalari">
        <g fontFamily="'Outfit',sans-serif">
          <g>
            <rect x="20" y="55" width="150" height="60" rx="10" fill="#132238" stroke="#C8A24A" strokeWidth="1.5" />
            <text x="95" y="80" textAnchor="middle" fill="#ffffff" fontSize="14" fontWeight="600">Discovery</text>
            <text x="95" y="100" textAnchor="middle" fill="#8b9198" fontSize="10.5" fontFamily="'Outfit',sans-serif">Talablar tasdiq</text>

            <rect x="228" y="55" width="150" height="60" rx="10" fill="#132238" stroke="#C8A24A" strokeWidth="1.5" />
            <text x="303" y="80" textAnchor="middle" fill="#ffffff" fontSize="14" fontWeight="600">Design</text>
            <text x="303" y="100" textAnchor="middle" fill="#8b9198" fontSize="10.5" fontFamily="'Outfit',sans-serif">Dizayn + hajm</text>

            <rect x="436" y="55" width="150" height="60" rx="10" fill="#132238" stroke="#A47D30" strokeWidth="2" />
            <text x="511" y="80" textAnchor="middle" fill="#ffffff" fontSize="14" fontWeight="600">Build</text>
            <text x="511" y="100" textAnchor="middle" fill="#8b9198" fontSize="10.5" fontFamily="'Outfit',sans-serif">Test sikl ishlaydi</text>

            <rect x="644" y="55" width="150" height="60" rx="10" fill="#132238" stroke="#6889A8" strokeWidth="1.5" />
            <text x="719" y="80" textAnchor="middle" fill="#ffffff" fontSize="14" fontWeight="600">Deploy</text>
            <text x="719" y="100" textAnchor="middle" fill="#8b9198" fontSize="10.5" fontFamily="'Outfit',sans-serif">UAT + Go-Live</text>

            <rect x="852" y="55" width="150" height="60" rx="10" fill="#132238" stroke="#6889A8" strokeWidth="1.5" />
            <text x="927" y="80" textAnchor="middle" fill="#ffffff" fontSize="14" fontWeight="600">Support</text>
            <text x="927" y="100" textAnchor="middle" fill="#8b9198" fontSize="10.5" fontFamily="'Outfit',sans-serif">Barqarorlik</text>
          </g>
          <g fill="#0E1A2B" stroke="#C8A24A" strokeWidth="1.5">
            <path d="M203,85 l12,-12 12,12 -12,12 z" />
            <path d="M411,85 l12,-12 12,12 -12,12 z" />
            <path d="M619,85 l12,-12 12,12 -12,12 z" stroke="#6889A8" />
            <path d="M827,85 l12,-12 12,12 -12,12 z" stroke="#6889A8" />
          </g>
          <text x="500" y="150" textAnchor="middle" fill="#8b9198" fontSize="12" letterSpacing="1">&#x25C6; = DARVOZA &middot; shart bajarilmasa keyingi fazaga o&rsquo;tilmaydi</text>
        </g>
      </svg>
