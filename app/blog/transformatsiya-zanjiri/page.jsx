...
export const metadata = {
  title: "Biznes transformatsiyasining 5 bosqichli zanjiri — Empire Group",
            ...
            <div className="tz-wrap">
              ...
              <div className="diagram reveal" style={{ marginTop: 38, padding: '24px 20px' }}>
                ...
                <svg viewBox="0 0 660 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Beshta bosqichdan iborat ko'tarilib boruvchi zinapoya">
                  <defs>
                    <marker id="axU" markerWidth="9" markerHeight="9" refX="4" refY="7" orient="auto"><path d="M4,0 L8,7 L0,7 Z" fill="#7C8AA0" /></marker>
                    <marker id="axR" markerWidth="9" markerHeight="9" refX="7" refY="4" orient="auto"><path d="M0,0 L7,4 L0,8 Z" fill="#7C8AA0" /></marker>
                  </defs>
                  <line x1="18" y1="278" x2="18" y2="60" stroke="#B7C0CD" strokeWidth="1.4" markerEnd="url(#axU)" />
                  <line x1="18" y1="278" x2="646" y2="278" stroke="#B7C0CD" strokeWidth="1.4" markerEnd="url(#axR)" />
                  <text x="24" y="52" fill="#7C8AA0" fontFamily="JetBrains Mono,monospace" fontSize="10.5" letterSpacing="1">QIYMAT · NAZORAT ↑</text>
                  <text x="646" y="296" textAnchor="end" fill="#7C8AA0" fontFamily="JetBrains Mono,monospace" fontSize="10.5" letterSpacing="1">YETUKLIK · VAQT →</text>

                  <g>
                    <rect x="26" y="250" width="112" height="28" rx="4" fill="#16273F" />
                    <rect x="146" y="212" width="112" height="66" rx="4" fill="#31456A" />
                    <rect x="266" y="174" width="112" height="104" rx="4" fill="#6C6A4C" />
                    <rect x="386" y="136" width="112" height="142" rx="4" fill="#9C7E3B" />
                    <rect x="506" y="98" width="112" height="180" rx="4" fill="#C99B45" />
                  </g>

                  <polyline points="82,250 202,212 322,174 442,136 562,98" fill="none" stroke="#B5842F" strokeWidth="1.6" strokeDasharray="5 4" opacity="0.85" />
                  <g fill="#B5842F">
                  ...
                  <g fontFamily="Outfit,sans-serif" textAnchor="middle">
                    <g><text x="82" y="234" fill="#C99B45" fontFamily="JetBrains Mono,monospace" fontSize="13" fontWeight="700">01</text><text x="82" y="248" fill="#122540" fontSize="10.5" fontWeight="600">Tizim</text></g>
                    <g><text x="202" y="196" fill="#C99B45" fontFamily="JetBrains Mono,monospace" fontSize="13" fontWeight="700">02</text><text x="202" y="210" fill="#122540" fontSize="10.5" fontWeight="600">Standart</text></g>
                    <g><text x="322" y="158" fill="#B5842F" fontFamily="JetBrains Mono,monospace" fontSize="13" fontWeight="700">03</text><text x="322" y="172" fill="#122540" fontSize="10.5" fontWeight="600">Raqamli</text></g>
                    <g><text x="442" y="120" fill="#B5842F" fontFamily="JetBrains Mono,monospace" fontSize="13" fontWeight="700">04</text><text x="442" y="134" fill="#122540" fontSize="10.5" fontWeight="600">Integratsiya</text></g>
                    <g><text x="562" y="82" fill="#B5842F" fontFamily="JetBrains Mono,monospace" fontSize="13" fontWeight="700">05</text><text x="562" y="96" fill="#122540" fontSize="10.5" fontWeight="600">Avtomat</text></g>
                  </g>

                  <text x="30" y="272" fill="#B9C6D8" fontFamily="Outfit,sans-serif" fontSize="10" fontWeight="600">Tartibsizlik</text>
                  <text x="562" y="292" textAnchor="middle" fill="#8a6a1f" fontFamily="Outfit,sans-serif" fontSize="10" fontWeight="700">Avtonom</text>
                </svg>
              </div>
            </div>
          </section>
                  ...
                  <div className="tz-card">
                    ...
                    <div className="diagram">
                      ...
                      <svg viewBox="0 0 540 116" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Tovar qabuli jarayoni: Qabul, Tekshiruv, Imzo va To'lov qadamlari">
                        <defs><marker id="a1" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#B5842F" /></marker></defs>
                        <g fontFamily="Outfit,sans-serif" textAnchor="middle">
                          <g><rect x="8" y="34" width="112" height="44" rx="9" fill="#0C1524" /><text x="64" y="54" fill="#C99B45" fontSize="12" fontWeight="700">QABUL</text><text x="64" y="70" fill="#9FB0C6" fontSize="9.5">Omborchi</text></g>
                          <line x1="122" y1="56" x2="152" y2="56" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#a1)" />
                          <g><rect x="154" y="34" width="112" height="44" rx="9" fill="#fff" stroke="#D8DEE7" /><text x="210" y="54" fill="#122540" fontSize="12" fontWeight="700">TEKSHIRUV</text><text x="210" y="70" fill="#54637A" fontSize="9.5">Sifat</text></g>
                          <line x1="268" y1="56" x2="298" y2="56" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#a1)" />
                          <g><rect x="300" y="34" width="112" height="44" rx="9" fill="#fff" stroke="#D8DEE7" /><text x="356" y="54" fill="#122540" fontSize="12" fontWeight="700">IMZO</text><text x="356" y="70" fill="#54637A" fontSize="9.5">Menejer</text></g>
                          <line x1="414" y1="56" x2="444" y2="56" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#a1)" />
                          <g><rect x="420" y="34" width="112" height="44" rx="9" fill="#fff" stroke="#D8DEE7" /><text x="476" y="54" fill="#122540" fontSize="12" fontWeight="700">TO&apos;LOV</text><text x="476" y="70" fill="#54637A" fontSize="9.5">Buxgalter</text></g>
                        </g>
                      </svg>
                    </div>
                  ...
                  <div className="tz-card">
                    ...
                    <div className="diagram">
                      ...
                      <svg viewBox="0 0 540 150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Uchta turli filial formati bitta yagona tasdiqlangan shablonga birlashadi">
                        <defs><marker id="a2" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#B5842F" /></marker></defs>
                        <g fontFamily="Outfit,sans-serif">
                          <g><rect x="8" y="12" width="132" height="34" rx="7" fill="#fff" stroke="#D8DEE7" /><line x1="20" y1="24" x2="70" y2="24" stroke="#B4453C" strokeWidth="2" /><line x1="20" y1="33" x2="95" y2="33" stroke="#C5AFA0" strokeWidth="2" /><text x="128" y="30" textAnchor="end" fill="#54637A" fontSize="10" fontWeight="600">Filial A</text></g>
                          <g><rect x="8" y="58" width="132" height="34" rx="7" fill="#fff" stroke="#D8DEE7" /><rect x="20" y="66" width="30" height="18" fill="#E7ECF2" /><line x1="56" y1="70" x2="100" y2="70" stroke="#B7C0CD" strokeWidth="2" /><text x="128" y="80" textAnchor="end" fill="#54637A" fontSize="10" fontWeight="600">Filial B</text></g>
                          <g><rect x="8" y="104" width="132" height="34" rx="7" fill="#fff" stroke="#D8DEE7" /><line x1="20" y1="115" x2="105" y2="115" stroke="#B7C0CD" strokeWidth="2" /><line x1="20" y1="124" x2="60" y2="124" stroke="#C5AFA0" strokeWidth="2" /><text x="128" y="122" textAnchor="end" fill="#54637A" fontSize="10" fontWeight="600">Filial C</text></g>
                          <g stroke="#B5842F" strokeWidth="1.7" fill="none" markerEnd="url(#a2)">
                            <path d="M144 29 C 210 40, 250 60, 300 72" />
                            <path d="M144 75 L 300 75" />
                            <path d="M144 121 C 210 110, 250 90, 300 78" />
                          </g>
                          <rect x="308" y="46" width="150" height="58" rx="11" fill="#0C1524" />
                          <text x="383" y="72" textAnchor="middle" fill="#C99B45" fontSize="13" fontWeight="700">YAGONA</text>
                          <text x="383" y="90" textAnchor="middle" fill="#9FB0C6" fontSize="11">ANDOZA &middot; shablon</text>
                        </g>
                      </svg>
                    </div>
                  ...
                  <div className="tz-card">
                    ...
                    <div className="diagram">
                      ...
                      <svg viewBox="0 0 540 130" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Qog'oz daftar va inson xotirasidagi ma'lumot raqamli ERP bazasiga ko'chadi">
                        <defs><marker id="a3" markerWidth="10" markerHeight="10" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#B5842F" /></marker></defs>
                        <g fontFamily="Outfit,sans-serif" textAnchor="middle">
                          <g>
                            <rect x="26" y="30" width="80" height="66" rx="5" fill="#fff" stroke="#C5AFA0" transform="rotate(-4 66 63)" />
                            <g stroke="#D8C7BB" strokeWidth="2">
                              <line x1="42" y1="48" x2="92" y2="46" /><line x1="42" y1="60" x2="92" y2="58" /><line x1="42" y1="72" x2="80" y2="70" />
                            </g>
                            <text x="66" y="116" fill="#8a6a55" fontSize="10.5" fontWeight="600">Daftar &middot; kalla</text>
                          </g>
                          <g>
                            <line x1="150" y1="63" x2="240" y2="63" stroke="#B5842F" strokeWidth="2" markerEnd="url(#a3)" />
                            <text x="196" y="52" fill="#B5842F" fontFamily="JetBrains Mono,monospace" fontSize="9.5" letterSpacing="1">KO&apos;CHIRISH</text>
                          </g>
                          <g>
                            <rect x="270" y="24" width="150" height="86" rx="9" fill="#0C1524" />
                            <rect x="284" y="38" width="122" height="12" rx="3" fill="#233a5c" />
                            <rect x="284" y="56" width="80" height="8" rx="2" fill="#C99B45" />
                            <rect x="284" y="70" width="122" height="8" rx="2" fill="#33456a" />
                            <rect x="284" y="84" width="96" height="8" rx="2" fill="#33456a" />
                            <text x="345" y="126" fill="#122540" fontSize="10.5" fontWeight="700">ERP &middot; CRM &middot; baza</text>
                          </g>
                          <text x="470" y="52" textAnchor="start" fill="#54637A" fontFamily="JetBrains Mono,monospace" fontSize="9">real-time</text>
                          <text x="470" y="70" textAnchor="start" fill="#54637A" fontFamily="JetBrains Mono,monospace" fontSize="9">qidiriladi</text>
                          <text x="470" y="88" textAnchor="start" fill="#54637A" fontFamily="JetBrains Mono,monospace" fontSize="9">nusxalanmas</text>
                        </g>
                      </svg>
                    </div>
                      ...
                      <svg viewBox="0 0 520 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ERP markazida turgan, bank, soliq, MES, kassa va Telegram bilan bog'langan tarmoq">
                        <defs>
                          <marker id="arrow" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
                            <path d="M0,0 L6,3 L0,6 Z" fill="#B5842F" />
                          </marker>
                        </defs>
                        <g stroke="#B5842F" strokeWidth="1.6" fill="none" opacity="0.55" markerEnd="url(#arrow)">
                        ...
                        <rect x="212" y="86" width="96" height="48" rx="11" fill="#0C1524" />
                        <text x="260" y="115" textAnchor="middle" fill="#C99B45" fontFamily="JetBrains Mono,monospace" fontSize="17" fontWeight="700">ERP</text>
                        <g fontFamily="Outfit,sans-serif" fontSize="12" fontWeight="600" fill="#122540">
                          <g><rect x="34" y="26" width="96" height="34" rx="8" fill="#fff" stroke="#D8DEE7" /><text x="82" y="47" textAnchor="middle">Bank / To&apos;lov</text></g>
                          <g><rect x="390" y="26" width="96" height="34" rx="8" fill="#fff" stroke="#D8DEE7" /><text x="438" y="47" textAnchor="middle">Soliq &middot; e-faktura</text></g>
                          <g><rect x="18" y="132" width="96" height="34" rx="8" fill="#fff" stroke="#D8DEE7" /><text x="66" y="153" textAnchor="middle">MES / Stanok</text></g>
                          <g><rect x="402" y="132" width="100" height="34" rx="8" fill="#fff" stroke="#D8DEE7" /><text x="452" y="153" textAnchor="middle">Kassa / POS</text></g>
                          <g><rect x="212" y="184" width="96" height="34" rx="8" fill="#fff" stroke="#D8DEE7" /><text x="260" y="205" textAnchor="middle">Telegram bot</text></g>
                        </g>
                      </svg>
                    </div>
                  ...
                  <div className="tz-card">
                    ...
                    <div className="diagram">
                      ...
                      <svg viewBox="0 0 540 130" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Hodisa, qoida va amal bosqichlaridan iborat avtomatlashtirish sikli">
                        ...
                        <g fontFamily="Outfit,sans-serif">
                          <g><rect x="8" y="40" width="118" height="50" rx="10" fill="#0C1524" />
                            <text x="67" y="62" textAnchor="middle" fill="#C99B45" fontSize="12" fontWeight="700">HODISA</text>
                            <text x="67" y="79" textAnchor="middle" fill="#9FB0C6" fontSize="10">Qoldiq &lt; min</text></g>
                          <line x1="128" y1="65" x2="162" y2="65" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#arrow2)" />
                          <g><rect x="164" y="40" width="118" height="50" rx="10" fill="#fff" stroke="#D8DEE7" />
                            <text x="223" y="62" textAnchor="middle" fill="#122540" fontSize="12" fontWeight="700">QOIDA</text>
                            <text x="223" y="79" textAnchor="middle" fill="#54637A" fontSize="10">Min-max mantiq</text></g>
                          <line x1="284" y1="65" x2="318" y2="65" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#arrow2)" />
                          <g><rect x="320" y="40" width="118" height="50" rx="10" fill="#fff" stroke="#D8DEE7" />
                            <text x="379" y="62" textAnchor="middle" fill="#122540" fontSize="12" fontWeight="700">AMAL</text>
                            <text x="379" y="79" textAnchor="middle" fill="#54637A" fontSize="10">PO yaratiladi</text></g>
                          <line x1="440" y1="65" x2="474" y2="65" stroke="#B5842F" strokeWidth="1.8" markerEnd="url(#arrow2)" />
                          <g><rect x="454" y="34" width="78" height="62" rx="10" fill="#F3F5F8" stroke="#B5842F" strokeDasharray="4 3" />
                            <text x="493" y="60" textAnchor="middle" fill="#B5842F" fontSize="11" fontWeight="700">INSON</text>
                            <text x="493" y="76" textAnchor="middle" fill="#54637A" fontSize="10">tasdiq</text></g>
                        </g>
                      </svg>
                    </div>
            ...
            <div className="tz-wrap">
              ...
              <div style={{ margin: '10px auto 34px', maxWidth: 560 }}>
                <svg viewBox="0 0 560 268" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Beshta qatlamli piramida: poydevorda tizimlashtirish, cho'qqida avtomatlashtirish">
                  <defs><marker id="gU" markerWidth="9" markerHeight="9" refX="4" refY="7" orient="auto"><path d="M4,0 L8,7 L0,7 Z" fill="#C99B45" /></marker></defs>
                  <g fontFamily="Outfit,sans-serif" textAnchor="middle">
                    <g>
                      <rect x="60" y="200" width="440" height="40" rx="5" fill="#21344F" stroke="rgba(255,255,255,.14)" />
                      <text x="280" y="225" fill="#EAEFF6" fontSize="13" fontWeight="600"><tspan fill="#C99B45" fontFamily="JetBrains Mono,monospace">01</tspan>  Tizimlashtirish</text>
                    </g>
                    <g>
                      <rect x="100" y="154" width="360" height="40" rx="5" fill="#3A5178" stroke="rgba(255,255,255,.14)" />
                      <text x="280" y="179" fill="#EAEFF6" fontSize="13" fontWeight="600"><tspan fill="#C99B45" fontFamily="JetBrains Mono,monospace">02</tspan>  Standartlashtirish</text>
                    </g>
                    <g>
                      <rect x="140" y="108" width="280" height="40" rx="5" fill="#7A6E48" stroke="rgba(255,255,255,.14)" />
                      <text x="280" y="133" fill="#EAEFF6" fontSize="13" fontWeight="600"><tspan fill="#EBD9AE" fontFamily="JetBrains Mono,monospace">03</tspan>  Raqamlashtirish</text>
                    </g>
                    <g>
                      <rect x="180" y="62" width="200" height="40" rx="5" fill="#A5843C" stroke="rgba(255,255,255,.16)" />
                      <text x="280" y="87" fill="#1a1206" fontSize="12.5" fontWeight="700"><tspan fontFamily="JetBrains Mono,monospace">04</tspan>  Integratsiya</text>
                    </g>
                    <g>
                      <rect x="212" y="16" width="136" height="40" rx="5" fill="#C99B45" stroke="rgba(255,255,255,.2)" />
                      <text x="280" y="41" fill="#1a1206" fontSize="12" fontWeight="700"><tspan fontFamily="JetBrains Mono,monospace">05</tspan>  Avtomat</text>
                    </g>
                  </g>
                  <line x1="524" y1="240" x2="524" y2="26" stroke="#C99B45" strokeWidth="1.4" strokeDasharray="5 4" markerEnd="url(#gU)" opacity="0.8" />
                  <text x="516" y="140" fill="#C99B45" fontFamily="JetBrains Mono,monospace" fontSize="10" letterSpacing="1" transform="rotate(90 516 140)" textAnchor="middle">QURILADI ↑</text>
                  <text x="36" y="264" fill="#8FA1B8" fontFamily="Outfit,sans-serif" fontSize="11">Poydevorsiz cho&apos;qqi qulaydi — yuqori qatlam faqat pastkilar ustida turadi.</text>
                </svg>
              </div>
